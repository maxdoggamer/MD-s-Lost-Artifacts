	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head = partdefinition.addOrReplaceChild("head",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-3.0F, -3.0F, -2.0F, 6.0F, 6.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(0, 10)
						.addBox(-1.5F, -0.0156F, -5.0F, 3.0F, 2.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(-1.0F, 13.5F, -7.0F));

		PartDefinition head_r1 = head
				.addOrReplaceChild("head_r1",
						CubeListBuilder.create().texOffs(50, 26).addBox(-2.5F, -10.5156F, -9.0F, 3.0F, 1.0F, 4.0F,
		...
		PartDefinition head_r2 = head.addOrReplaceChild("head_r2",
				CubeListBuilder.create().texOffs(56, 19)
						.addBox(0.5F, -8.5156F, -10.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 19)
						.addBox(2.5F, -8.5156F, -11.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 19)
						.addBox(3.5F, -8.5156F, -11.0F, 2.0F, 1.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(56, 19)
						.addBox(4.5F, -8.5156F, -10.0F, 2.0F, 1.0F, 4.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition head_r3 = head.addOrReplaceChild("head_r3",
				CubeListBuilder.create().texOffs(16, 14)
						.addBox(0.0F, -4.5F, -15.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)).texOffs(16, 14)
						.addBox(-4.0F, -4.5F, -15.0F, 2.0F, 2.0F, 1.0F, new CubeDeformation(0.0F)),
		...
		PartDefinition leg0_r1 = leg0
				.addOrReplaceChild("leg0_r1",
						CubeListBuilder.create().texOffs(0, 18).addBox(-3.5F, 2.0F, 6.0F, 2.0F, 8.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(2.5F, 6.0F, -7.0F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition leg1_r1 = leg1.addOrReplaceChild("leg1_r1",
				CubeListBuilder.create().texOffs(0, 18).addBox(-0.5F, 2.0F, 6.0F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(-0.5F, 6.0F, -7.0F, 1.1345F, 0.0F, 0.0F));
		...
		PartDefinition leg2_r1 = leg2
				.addOrReplaceChild("leg2_r1",
						CubeListBuilder.create().texOffs(0, 18).addBox(-3.5F, -8.0F, 4.0F, 2.0F, 8.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(2.5F, 8.0F, 4.0F, 1.1781F, 0.0F, 0.0F));
		...
		PartDefinition leg3_r1 = leg3
				.addOrReplaceChild("leg3_r1",
						CubeListBuilder.create().texOffs(0, 18).addBox(-0.5F, -8.0F, 4.0F, 2.0F, 8.0F, 2.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(-0.5F, 8.0F, 4.0F, 1.1781F, 0.0F, 0.0F));
		...
		PartDefinition tail_r1 = tail.addOrReplaceChild("tail_r1",
				CubeListBuilder.create().texOffs(9, 18).addBox(-2.0F, -5.0F, 12.0F, 2.0F, 8.0F, 2.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 12.0F, -8.0F, 0.6109F, 0.0F, 0.0F));
