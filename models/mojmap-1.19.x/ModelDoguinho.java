...
public class ModelDoguinho<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "doguinho"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = head.addOrReplaceChild("head_r1",
				CubeListBuilder.create().texOffs(54, 19)
						.addBox(-3.25F, -10.2656F, -9.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(54, 19)
						.addBox(-2.5F, -11.0156F, -9.0F, 1.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.0F, 10.5F, 7.0F, 0.264F, 0.1264F, 0.0341F));

		PartDefinition head_r2 = head.addOrReplaceChild("head_r2",
				CubeListBuilder.create().texOffs(54, 19).addBox(0.75F, -11.0156F, -8.5F, 2.0F, 1.0F, 3.0F,
		...
		PartDefinition head_r3 = head
				.addOrReplaceChild("head_r3",
						CubeListBuilder.create().texOffs(50, 26).addBox(-2.5F, -11.5156F, -8.0F, 3.0F, 1.0F, 4.0F,
								new CubeDeformation(0.0F)),
