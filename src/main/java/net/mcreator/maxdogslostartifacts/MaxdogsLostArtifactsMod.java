 ...
 *
 */
package net.mcreator.maxdogslostartifacts;
...
@Mod("maxdogs_lost_artifacts")
public class MaxdogsLostArtifactsMod {
	public static final Logger LOGGER = LogManager.getLogger(MaxdogsLostArtifactsMod.class);
	public static final String MODID = "maxdogs_lost_artifacts";
	...
	public MaxdogsLostArtifactsMod() {
		...
		MaxdogsLostArtifactsModTabs.REGISTRY.register(bus);
